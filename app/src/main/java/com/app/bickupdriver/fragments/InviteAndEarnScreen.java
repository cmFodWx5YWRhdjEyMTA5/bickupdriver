...
public class InviteAndEarnScreen extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String referralCode = sharedPreferencesManager.getStringData(SharedPreferencesManager.REFERRAL_CODE);
