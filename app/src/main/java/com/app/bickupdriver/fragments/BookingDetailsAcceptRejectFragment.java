...
public class BookingDetailsAcceptRejectFragment extends Fragment implements View.OnClickListener,
        OnMapReadyCallback {

    private static int REQUEST_CODE_LOCATION_PERMISSION = 578;
    public static String Tag = BookingDetailsAcceptRejectFragment.class.getSimpleName();
    ...
    public BookingDetailsAcceptRejectFragment() {
    ...
    private void initializeViews(View view) {
        ...
        tvPickupAdditionalComment = view.findViewById(R.id.tv_pickup_additional_comment);
        tvDropAdditionalComment = view.findViewById(R.id.tv_drop_additional_comment);
        ivNumberOfHelpers = view.findViewById(R.id.iv_number_of_helper_top);
        tvNumberOfHelpersTop = view.findViewById(R.id.tv_number_of_helpers_top);
    }
    ...
    private void setDataOnViews(Ride ride) {
        ...
        if (rideNew != null) {
            ...
            String formattedDate = Utils.getFormattedDate(getContext(), ride.timestamp); // today 10:15 PM
            ...
            if (rideNew.goodsImageList != null && rideNew.goodsImageList.size() > 0) {
                Utils.printLogs(TAG, "" + rideNew.goodsImage);
                this.setGoodsImageListAdapter(rideNew.goodsImageList);
            }

            // TODO: 9/5/18

            if (rideNew.pickupComment == null) {
                tvPickupAdditionalComment.setVisibility(View.GONE);
            } else {
                tvPickupAdditionalComment.setText("" + rideNew.pickupComment);
            }

            if (rideNew.dropComment == null) {
                tvDropAdditionalComment.setVisibility(View.GONE);
            } else {
                tvDropAdditionalComment.setText("" + rideNew.dropComment);
            }
    ...
    public void onAttach(Context context) {
        ...
        mActivityReference = (BookingDetailsAcceptRejectActivity) getContext();
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        if (googleMap != null) {
            ...
            /*LatLng currentLatLng = new LatLng(Double.parseDouble(mActivityReference.rideNew.pickupLatitude), Double.parseDouble(mActivityReference.rideNew.pickupLongitude));
            LatLng destLatLng = new LatLng(Double.parseDouble(mActivityReference.rideNew.dropLatitude), Double.parseDouble(mActivityReference.rideNew.dropLongitude));
            drawRouteBetweenTwoPlaces(currentLatLng, destLatLng);*/
...
/*
    ...
    public void onRoutingStart() {
        Utils.printLogs(TAG, "onRoutingStart");
    }
